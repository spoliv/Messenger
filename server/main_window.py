...
class MainWindow(QMainWindow):
    def __init__(self, database, server, config):
        ...
        # Кнопка добавления аватара пользователя
        self.add_avatar_btn = QAction('Добавление аватара', self)
        ...
        self.toolbar.addAction(self.add_avatar_btn)
        ...
        self.add_avatar_btn.triggered.connect(self.add_avat_user)
    ...
    def add_avat_user(self):
        fname = QFileDialog.getOpenFileName(self, 'Open file', '/home/picforavat')[0]
        self.fname = fname
        file = Image.open(self.fname)
        width = 80
        height = 60
        our_pict = file.resize((width, height), Image.BICUBIC)
        our_pict.save("avatars/avatar.jpg")
        file = open("avatars/avatar.jpg", "rb")
        our_pict = file.read()
        file.close()
